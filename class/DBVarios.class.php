...
//Clase DBVarios                                          //
//***********************************************************//
class DBVarios extends Conexion
{
    // Constructor
    function DBVarios(){
            $this->conecta_pdo();
...
*/
    ...
    {
            $elselect = "<select name='$nombre' class='form-control' $disabled ";
...
?>
<table><tr>
<td><a href="javascript:toggleLayer('wait_bar');makerequest('<?=$url_primero?>','<?=$seccion?>');" class="titulonegro"><img src="/images/ar_prev.gif" border=0 ><img src="/images/ar_prev.gif" border=0></a></td>
<td><a href="javascript:toggleLayer('wait_bar');makerequest('<?=$url_prev?>','<?=$seccion?>');" class="titulonegro"><img src="/images/leftarrow.gif" border=0 ></a></td>
<?php
...
<?*/
?>
<td><a href="javascript:toggleLayer('wait_bar');makerequest('<?="$url&primero$prefix=$pag&limite$prefix=$limite&lapag$prefix=$p&inicio$prefix=$inicio"?>','<?=$seccion?>');" class='contenidoblanco' style="text-decoration:none;"><?="$pag_mark"?></a></td>
<?php
...
?>
<td><a href="javascript:toggleLayer('wait_bar');makerequest('<?=$url_next?>','<?=$seccion?>');" class="titulonegro"><img src="/images/rightarrow.gif" border=0></a>&nbsp;</td>
<td><a href="javascript:toggleLayer('wait_bar');makerequest('<?=$url_ultimo?>','<?=$seccion?>');" class="titulonegro"><img src="images/ar_next.gif" border=0><img src="images/ar_next.gif" border=0></a>&nbsp;</td>
<td><div id="wait_bar" style="display:none"><img src="/images/bar_wait.gif" border="0"></div></td>
</table>
<?php
            }
...
//	}
    ...
    function extFile($file){
        return strtoupper(substr($file,strrpos($file,'.')+1,strlen($file)));
    }
