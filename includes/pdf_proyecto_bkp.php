...
<table width="100%" border="0">
    <tr>
        <th colspan="13">Detalle Trabajos</th>    
    </tr>    
    <tr>
        <td>Cod</td>
        <td>Item</td>
    ...
    <tr>
        <td><?=$codigo?></td>
        <td><?=$item?></td>
        <td align="right"><?=$dias_taller_cerrados?></td>
        <td align="right"><?=$delta_taller?></td>
        <td align="center"><?=$Aux->marcaX($taller)?></td>
        <td align="center"><?=$Aux->marcaX($seguimiento_taller)?></td>
        <td align="center"><?=$Aux->marcaX($solo_seguimiento)?></td>
        <td align="center"><?=$Aux->marcaX($oc)?></td>
        <td align="center"><?=$Aux->marcaX($hes)?></td>
        <td align="right"><?=$por_anticipo?>%</td>
        <td align="right"><?=$por_entrega?>%</td>
        <td align="right"><?=$por_aprobado?>%</td>
...
<?php
    ...
    <tr valign="top">
        <td colspan="2">Total Taller</td>
        <td align="right"><?=number_format($total_dias_taller_cerrados,0,",",".")?></td>
        <td align="right"><?=number_format($total_dias_taller,0,",",".")?></td>
        <td colspan="9">&nbsp;</td>
    </tr>
</table>
<?php
